...
public class View_Document_Waiting {
  ...
  @Test
  public void main() {
	  //Click the View button next to Document Wait
	  driver.findElement(By.cssSelector("a[href='ViewDocList.aspx?DCSTAT=4002']")).click();
	  ...
	  Assert.assertTrue(Filter_status.equals("Waiting"));
	  ...
	  do{
	  			...
	  			for (int x = 1; x < table_row.size(); x++){
	  				...
	  				Assert.assertTrue(table_data.get(4).getText().equals("Waiting"));
	  ...
	  System.out.println( document_count + " documents are waiting");
