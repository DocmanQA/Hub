...
public class DeleteDocAndArchive {
  ...
  public void main() {
	  ...
	  Assert.assertTrue(Audit_Match, "The archive audit file name is not exist.");
	  System.out.println("Pass. Audit file match.");
	  Assert.assertTrue(Doc_Match, "The archive doc file name is not exist.");
	  System.out.println("Pass. Document file match.");
	  Assert.assertTrue(Meta_Match, "The archive meta file name is not exist.");
